...
Router.post('/create', verifyToken, MidPenyewa, bookingControllers.createBooking);
...
Router.get('/booking/:id', verifyToken, MidPengelola, bookingControllers.getBookingByIdBooking);
Router.delete('/delete/:id', verifyToken, MidPengelola, bookingControllers.deleteBookingByIdBooking);
